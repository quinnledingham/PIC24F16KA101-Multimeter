...
#pragma config FCKSM = CSECMD           // Clock Switching and Monitor Selection (Both Clock Switching and Fail-safe Clock Monitor are disabled)
...
// FICD
#pragma config ICS = PGx2               // ICD Pin Placement Select bits (PGC1/PGD1 are used for programming and debugging the device)
